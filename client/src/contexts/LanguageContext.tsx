...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "contact.wechatIdPlaceholder": "Your WeChat ID (for us to contact you)",
    "contact.message": "Student Background & Study Abroad Needs *",
    "contact.messagePlaceholder": "E.g.: Student is currently in Year 11 (Senior 2), attending a domestic public high school; average score 85, IELTS 6.0; planning to apply for Singapore undergraduate programs in 2027, targeting NUS/NTU, interested in Business. Would like to know which universities are achievable with current grades, and what preparation steps are needed.",
  ...
  zh: {
    ...
    "contact.wechatIdPlaceholder": "请填写您的微信号（方便我们联系您）",
    "contact.message": "学生基本情况及升学需求 *",
    "contact.messagePlaceholder": "例如：学生目前高二，就读国内普高；平均成绩85分，雅思6.0；计划2027年申请新加坡本科，目标NUS/NTU，意向商科。希望了解目前成绩能申请哪些学校，以及接下来需要如何准备。",
    "contact.submit": "发送消息",
    "contact.or": "或直接联系我们",
    "contact.wechat": "微信",
    "contact.linkedin": "领英",
